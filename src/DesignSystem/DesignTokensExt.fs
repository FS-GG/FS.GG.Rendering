...
module DesignTokensExt =
    ...
    module Map =
        ...
        module Dark =
            ...
            let colorSuccess : Color = Colors.rgba 73uy 170uy 25uy 255uy
            let colorWarning : Color = Colors.rgba 216uy 150uy 20uy 255uy
            let colorError : Color = Colors.rgba 220uy 68uy 70uy 255uy

...
module Catalog =
    ...
    let supportedControls =
        [
            ...
            definition
                ...
                "display"
                "Canvas"
                "Embedded drawing surface painting an application-supplied Scene into its laid-out box; forwards raw pointer/keyboard input."
                []
                common
                [ "onPointer"; "onKey" ]
                states
            ...
            definition
                ...
                "custom"
                "CustomControl"
                "Product-owned wrapper for events/attributes; renderTree paints a labeled placeholder — draw arbitrary geometry with the canvas kind, or build must-show chrome from primitive controls (Border/TextBlock/Stack)."
                []
                common
                [ "onCustom" ]
                states
            ...
            definition
                ...
                "display"
                "Avatar"
                "Round monogram or image stand-in."
                []
                common
                []
                states
            ...
            definition
                ...
                "display"
                "Card"
                "Framed content surface with a header band."
                []
                common
                []
                states
            ...
            definition
                ...
                "display"
                "Statistic"
                "Emphasised metric over a caption."
                []
                common
                []
                states
            ...
            definition
                ...
                "display"
                "Watermark"
                "Faint repeated brand text overlay."
                []
                common
                []
                states
            ...
            definition
                ...
                "feedback"
                "Result"
                "Centred operation-outcome panel."
                []
                common
                []
                states
            ...
            definition
                ...
                "feedback"
                "Popover"
                "Floating callout anchored to a trigger."
                []
                common
                []
                states
            ...
            definition
                ...
                "feedback"
                "Popconfirm"
                "Confirm callout with accept/cancel."
                []
                common
                [ "onConfirm"; "onCancel" ]
                states
            ...
            definition
                ...
                "feedback"
                "Tour"
                "Guided multi-step highlight callout."
                []
                common
                []
                states
            ...
            definition
                ...
                "navigation"
                "Steps"
                "Numbered horizontal progress steps."
                []
                common
                []
                states
            ...
            definition
                ...
                "navigation"
                "Segmented"
                "Connected single-select segment row."
                []
                common
                [ "onChange" ]
                states
            ...
            definition
                ...
                "display"
                "Collapse"
                "Stacked expandable section headers."
                []
                common
                [ "onChange" ]
                states
            ...
            definition
                ...
                "input"
                "AutoComplete"
                "Text field with a suggestion dropdown."
                []
                common
                [ "onChange" ]
                states
            ...
            definition
                ...
                "input"
                "Upload"
                "File drop zone with an upload action."
                []
                common
                [ "onChange" ]
                states
            ...
            definition
                ...
                "input"
                "KeyRebind"
                "Config screen listing rebindable commands, their key bindings, and keymap conflicts."
                []
                common
                [ "onRebind" ]
                states
            ...
            definition
                ...
                "chart"
                "AreaChart"
                "Controls-owned filled-area trend visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "ColumnChart"
                "Controls-owned vertical-bar categorical visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "Histogram"
                "Controls-owned frequency-distribution visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "BoxPlot"
                "Controls-owned box-and-whisker distribution visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "Heatmap"
                "Controls-owned colour-intensity grid visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "RadarChart"
                "Controls-owned multi-axis polygon visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "RoseChart"
                "Controls-owned polar-area (Nightingale) visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "WaterfallChart"
                "Controls-owned cumulative-delta visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "FunnelChart"
                "Controls-owned stage-conversion visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "GaugeChart"
                "Controls-owned single-value dial visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "graph"
                "SankeyDiagram"
                "Controls-owned flow-between-nodes visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "graph"
                "ChordDiagram"
                "Controls-owned node-relationship ring visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "Treemap"
                "Controls-owned nested-rectangle hierarchy visualization."
                []
                common
                []
                states
            ...
            definition
                ...
                "chart"
                "Sunburst"
                "Controls-owned radial-hierarchy visualization."
                []
                common
                []
                states
    ...
    let standardSchema =
        [
            ...
            }
            {
                ...
                SupportedAttributes =
                    [
                        StandardAttributeName.Columns
                        StandardAttributeName.Rows
                        StandardAttributeName.VisibleRange
                        StandardAttributeName.SelectedRows
                        StandardAttributeName.FocusedCell
                    ]
                SupportedEvents =
                    [
                        StandardEventKind.Selected
                        StandardEventKind.FocusChanged
                        StandardEventKind.SortChanged
                    ]
                CustomAllowed = false
            }
        ]

    let knownControlKinds () = standardSchema |> List.map _.Kind
        ...
        | Some schema ->
            ...
            let unsupportedAttributes =
                ...
                |> List.choose (fun attr ->
                    ...
                    | Some standard when
                        attr.Category <> Event
                        && not (schema.SupportedAttributes |> List.contains standard)
                        ->
            ...
            let unsupportedEvents =
                ...
                |> List.choose (fun attr ->
                    ...
                    | Some standard when
                        attr.Category = Event && not (schema.SupportedEvents |> List.contains standard)
                        ->
    ...
    let categories () =
        supportedControls |> List.map _.Category |> List.distinct |> List.sort
            ...
            if supportedCount () < 30 then
                yield
                    Diagnostics.create
                        ...
                        "Catalog has fewer than 30 supported controls."
                ...
                if row.Owner <> "controls" then
                    yield
                        Diagnostics.create
                            ...
                            ControlDiagnosticSeverity.Error
                            "Catalog row is not Controls-owned."
                ...
                if String.IsNullOrWhiteSpace row.Purpose then
                    yield
                        Diagnostics.create
                            ...
                            MissingRequiredAttribute
                            ControlDiagnosticSeverity.Error
                            "Catalog row is missing purpose."
                ...
                if row.VisualStates.IsEmpty then
                    yield
                        Diagnostics.create
                            ...
                            MissingRequiredAttribute
                            ControlDiagnosticSeverity.Error
                            "Catalog row is missing visual states."
                ...
                if row.Examples.IsEmpty || row.Tests.IsEmpty || row.Evidence.IsEmpty then
                    yield
                        Diagnostics.create
                            ...
                            MissingRequiredAttribute
                            ControlDiagnosticSeverity.Error
                            "Catalog row is missing examples, tests, or evidence."
                ...
                if row.Accessibility.Role.Trim() = "" then
                    yield
                        Diagnostics.create
                            ...
                            ControlDiagnosticSeverity.Error
                            "Catalog row is missing accessibility role."
            for row in supportedControls do
                if row.Id = "data-grid" && row.Category <> "data" && row.Category <> "collection" then
                    yield
                        Diagnostics.create
                            ...
                            ControlDiagnosticSeverity.Error
                            "DataGrid must be categorized as data or collection."
                ...
                if row.Id = "data-grid" && row.Module <> "DataGrid" then
                    yield
                        Diagnostics.create
                            ...
                            StaleGeneratedReference
                            ControlDiagnosticSeverity.Error
                            "DataGrid catalog row must be owned by the Controls DataGrid module."
                ...
                if row.Id = "rich-text" && row.Module <> "RichText" then
                    yield
                        Diagnostics.create
                            ...
                            MissingRequiredAttribute
                            ControlDiagnosticSeverity.Error
                            "Rich text catalog row must reference the RichText module."
        ]

...
/// containment, and centering surface that generated products reuse instead of hand-rolling
/// their own geometry. All functions are pure and total (NaN-safe; degenerate rects never throw).
/// Convention: `intersects` uses strict edges (touching is NOT overlap); `contains`/`containsPoint`
/// are inclusive of shared edges — matching the framework's existing internal placement logic.

...
module SpatialWorkingSet =
    ...
    val create:
        chunkSize: float ->
        entries: SpatialEntry<'value> list ->
            Result<SpatialWorkingSetIndex<'value>, SpatialWorkingSetIssue list>

    /// Query viewport plus overscan, retaining pinned items even when they are outside the viewport.
    val query:
        query: SpatialQuery ->
        index: SpatialWorkingSetIndex<'value> ->
            Result<SpatialWorkingSetResult<'value>, SpatialWorkingSetIssue list>

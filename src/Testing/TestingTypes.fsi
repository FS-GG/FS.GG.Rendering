...
type PackageReferenceExpectation = { PackageId: string; Required: bool }
...
type VisualInspectionRule = { RuleId: string; Required: bool }
...
type RetainedInspectionRule = { RuleId: string; Required: bool }
...
/// Public contract type exposed by this FS.GG.UI package.
type EvidenceReportField = { Name: string; Value: string }

...
module internal ViewerResponsivenessReport =
    ...
    let responsivenessInputKindToken kind =
        ViewerResponsiveness.responsivenessInputKindToken kind
    ...
    let responsivenessReadinessToken readiness =
        ViewerResponsiveness.responsivenessReadinessToken readiness

    let createResponsivenessRunId () =
        ViewerResponsiveness.createResponsivenessRunId ()
    ...
    let summarizeResponsivenessRecords
        ...
        ViewerResponsiveness.summarizeResponsivenessRecords
            runId
            scope
            recordsPath
            startedUtc

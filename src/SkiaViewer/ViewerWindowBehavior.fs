        ...
        let resize =
            ...
            | Resizable ->
                optionResult
                    ...
                    (Some "resizable")
                    Honored
                    "Resize policy can be honored by the viewer host."
            | FixedSize ->
                optionResult
                    "resize"
                    "fixed-size"
                    (Some "fixed-size")
                    Honored
                    "Fixed-size window policy can be honored by the viewer host."
        ...
        let maximize =
            ...
            | NotMaximizable ->
                optionResult
                    "maximize"
                    "not-maximizable"
                    (Some "not-maximizable")
                    Honored
                    "Maximize-disabled policy can be honored by the viewer host."
        ...
        let startupState =
            ...
            | ViewerWindowStartupState.Normal ->
                optionResult
                    ...
                    (Some "normal")
                    Honored
                    "Normal startup state can be honored by the viewer host."
            | ViewerWindowStartupState.Maximized ->
                optionResult
                    "startup-state"
                    "maximized"
                    (Some "maximized")
                    Honored
                    "Maximized startup state can be requested."
            | ViewerWindowStartupState.Minimized ->
                optionResult
                    ...
                    None
                    UnsupportedOption
                    "Minimized startup is not accepted for visible interactive launch validation."
            | ViewerWindowStartupState.Fullscreen ->
                optionResult
                    ...
                    (Some "fullscreen")
                    Honored
                    "Fullscreen startup can be honored by the viewer host."
        ...
        let startupPosition =
            ...
            | Some Centered ->
                optionResult
                    ...
                    (Some "centered")
                    Honored
                    "Centered startup can be requested."
            ...
            | Some(Coordinates(x, y)) ->
                optionResult
                    ...
                    (Some $"{x},{y}")
                    Honored
                    "Startup coordinates can be requested."
        ...
        let backend =
            ...
            | None ->
                optionResult
                    ...
                    (Some "default")
                    Degraded
                    "No backend requested; default backend will be selected."
            | Some ViewerBackendPreference.DefaultBackend ->
                optionResult "backend" "default" (Some "default") Honored "Default backend will be selected."
            | Some ViewerBackendPreference.OpenGL ->
                optionResult "backend" "opengl" (Some "opengl") Honored "OpenGL backend can be requested."
            | Some ViewerBackendPreference.Vulkan ->
                optionResult
                    ...
                    None
                    UnsupportedOption
                    "Vulkan backend is no longer supported; this viewer host presents through OpenGL (feature 119)."
            | Some ViewerBackendPreference.Software ->
                optionResult
                    ...
                    None
                    UnsupportedOption
                    "Software backend preference is not supported by this viewer host."

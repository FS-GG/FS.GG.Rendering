...
let full =
    Perf.summarizeSamples "raw/fsi-full-redraw.csv" [ 13.605; 13.782; 14.054; 13.221; 13.488 ]

let damage =
    Perf.summarizeSamples "raw/fsi-damage-scoped.csv" [ 13.278; 13.991; 14.296; 13.125; 13.401 ]

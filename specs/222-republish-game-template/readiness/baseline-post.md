...
| `tests/Package.Tests/Package.Tests.fsproj` | 🔴 FAIL | Failed!  - Failed:     1, Passed:   153, Skipped:     0, Total:   154, Duration: 92 ms - Package.Tests.dll (net10.0) |
| `tests/Rendering.Harness.Tests/Rendering.Harness.Tests.fsproj` | 🔴 FAIL | (no summary line; build/restore failure) |
| `tests/Scene.Tests/Scene.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    78, Skipped:     0, Total:    78, Duration: 115 ms - Scene.Tests.dll (net10.0) |
...
| `samples/ControlsGallery/ControlsGallery.Tests/ControlsGallery.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    34, Skipped:     0, Total:    34, Duration: 691 ms - ControlsGallery.Tests.dll (net10.0) |
...
- `tests/Package.Tests/Package.Tests.fsproj` (exit 1): Failed!  - Failed:     1, Passed:   153, Skipped:     0, Total:   154, Duration: 92 ms - Package.Tests.dll (net10.0)
...
## T027 — Regression verdict

Re-run after the release (zero `src/.fs` change on this feature). The per-project red/green set is
**identical** to the pre-release `baseline.md` (T002): 21 projects · 7 green / 14 red. The 14 red are
the pre-existing NU1403 FSharp.Core lockfile restore failures + the known `Package.Tests` Build-engine
baseline red — **not regressions**. **Zero new reds.** ✅

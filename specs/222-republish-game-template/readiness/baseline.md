...
| `tests/Package.Tests/Package.Tests.fsproj` | 🔴 FAIL | Failed!  - Failed:     1, Passed:   153, Skipped:     0, Total:   154, Duration: 89 ms - Package.Tests.dll (net10.0) |
| `tests/Rendering.Harness.Tests/Rendering.Harness.Tests.fsproj` | 🔴 FAIL | (no summary line; build/restore failure) |
| `tests/Scene.Tests/Scene.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    78, Skipped:     0, Total:    78, Duration: 123 ms - Scene.Tests.dll (net10.0) |
| `tests/SkiaViewer.Tests/SkiaViewer.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:   213, Skipped:     0, Total:   213, Duration: 969 ms - SkiaViewer.Tests.dll (net10.0) |
...
| `samples/ControlsGallery/ControlsGallery.Tests/ControlsGallery.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    34, Skipped:     0, Total:    34, Duration: 660 ms - ControlsGallery.Tests.dll (net10.0) |
| `samples/SampleApps/SampleApps.Tests/SampleApps.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    25, Skipped:     0, Total:    25, Duration: 244 ms - SampleApps.Tests.dll (net10.0) |
...
- `tests/Package.Tests/Package.Tests.fsproj` (exit 1): Failed!  - Failed:     1, Passed:   153, Skipped:     0, Total:   154, Duration: 89 ms - Package.Tests.dll (net10.0)

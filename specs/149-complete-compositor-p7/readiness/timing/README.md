# Feature 149 Timing Artifacts

## Schema

- `timing-damage.md`: damage-scoped redraw timing against the full-frame oracle.
- `timing-placement.md`: placement/reuse timing against damage or lower redraw tier.
- `timing-replay.md`: replay timing against placement/lower tier and full-frame oracle.
...
The deterministic harness can format tier reports and readiness summaries. Real timing claims remain limited until a capable host run produces comparable measured frame data.

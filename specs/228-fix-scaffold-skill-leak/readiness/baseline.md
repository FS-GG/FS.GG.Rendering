...
| `tests/Package.Tests/Package.Tests.fsproj` | 🔴 FAIL | (no summary line; build/restore failure) |
...
| `samples/SampleApps/SampleApps.Tests/SampleApps.Tests.fsproj` | 🟢 PASS | Passed!  - Failed:     0, Passed:    25, Skipped:     0, Total:    25, Duration: 256 ms - SampleApps.Tests.dll (net10.0) |
...
- `tests/Package.Tests/Package.Tests.fsproj` (exit 1): (no summary line; build/restore failure)

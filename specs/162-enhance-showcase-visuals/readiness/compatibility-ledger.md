...
- AntShowcase package references were moved from `0.1.0-preview.1` to the current locally packed `0.1.24-preview.1` package set so the sample validates the current package feed.

...
let private verifyGatedSources () =
    ...
    assertTrue (frameworkChecked = 17) (sprintf "expected exactly 17 framework product-skill sources (.agents/skills/ provider surface incl. fs-gg-project + fs-gg-collision + fs-gg-visibility + fs-gg-grids, no twins), checked %d" frameworkChecked)

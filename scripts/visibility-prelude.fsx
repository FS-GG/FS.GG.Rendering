...
// and drives it exactly as a game consumer would. Run after a build of Canvas.Tests (which restores
// FS.GG.Game.Core, the only package the fragment consumes):
//   dotnet test tests/Canvas.Tests/Canvas.Tests.fsproj && dotnet fsi scripts/visibility-prelude.fsx

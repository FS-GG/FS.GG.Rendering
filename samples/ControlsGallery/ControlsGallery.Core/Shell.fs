        ...
        [
            ...
            Stack.children
                [
                    ...
                    Button.create
                        [
                            Button.text "Accent: Indigo"
                            Button.onClick (SelectAccent GalleryTheme.indigo)
                        ]
...
let private navRail (_model: GalleryModel) : Control<GalleryMsg> =
    let item (p: GalleryPage) =
        Button.create
            [
                Button.text (sprintf "%d. %s" p.Index p.Title)
...
let private content (model: GalleryModel) : Control<GalleryMsg> =
    ...
    let props =
        FS.GG.UI.Controls.Typed.ScrollViewer.defaults "content-scroll" (Widget.ofControl body)
            ...
            Stack.children
                [
                    ...
                    Stack.create
                        [
                            Stack.orientation "horizontal"
                            Stack.children [ navRail model; content model ]
                        ]
                    statusStrip model
                ]
        ]

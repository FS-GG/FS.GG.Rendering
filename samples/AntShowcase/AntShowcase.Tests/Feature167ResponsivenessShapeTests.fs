module AntShowcase.Tests.Feature167ResponsivenessShapeTests
...
[<Tests>]
let tests =
    testList "Feature167 AntShowcase responsiveness shape" [
        ...
        test "representative deterministic substitute changes product state through keyboard activation" {
            let metrics = ControlsElmish.Perf.runScript Host.defaultHost AntShowcase.Tests.Feature167ResponsivenessFixtures.size (Scripts.representative "buttons")

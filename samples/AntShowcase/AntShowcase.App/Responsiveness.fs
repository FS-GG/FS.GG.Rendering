    ...
    let records =
        [
            recordJson
                ...
                [
                    "SYNTHETIC: deterministic headless substitute; no live GL presentation boundary measured."
                ]
            recordJson
                run
                2
                ...
                0.0
                0
                [ "SYNTHETIC: pointer shape captured without live presentation." ]
            recordJson
                run
                3
                "key-down"
                ...
                0.0
                0
                [ "SYNTHETIC: keyboard activation shape captured without live presentation." ]
            recordJson
                run
                4
                "key-down"
            ...
            recordJson
                ...
                0.0
                0
                [ "no visible response expected for Escape in the representative script." ]
        ]
...
let run (args: string list) =
    ...
    | Ok request ->
        try
            ...
            let metrics =
                ControlsElmish.Perf.runScript host size (Scripts.representative request.Page)

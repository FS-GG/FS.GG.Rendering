...
let runCapture args =
    ...
    | Some seedText, Some sizeText, Some themeText ->
        ...
        | (true, seed), Result.Ok size, Result.Ok themes, Result.Ok pages ->
            let outDir =
                flag "--out" args
                |> Option.defaultValue "artifacts/ant-showcase-visual-readiness"
            ...
            printfn
                "ant-showcase: visual-readiness %s, screenshots %d/%d under %s"
...
let runSummary args =
    ...
    | Some dir when Directory.Exists dir ->
        let outDir =
            flag "--out" args
            |> Option.defaultValue "specs/164-shared-visual-readiness/readiness"
        ...
        if update.SafeToWrite then
            ...
            eprintfn
                "ant-showcase: refused to update malformed visual-readiness managed section: %s"

...
let tests =
    testList
        "Feature174 visual parity coverage"
        [
            ...
            test "button and dense input pages are catalog pages with executable views" {
                ...
                Expect.isGreaterThan
                    (Control.count (buttonPage.View DemoState.seed))
                    0
                    "button page builds a control tree"

                Expect.isGreaterThan
                    (Control.count (inputPage.View DemoState.seed))
                    0
                    "input page builds a control tree"
            }

module SecondAntShowcase.Tests.Feature144DatePickerStaleOverlayTests
...
let tests =
    testList
        "Feature144 SecondAntShowcase date-picker stale-overlay proof"
        [

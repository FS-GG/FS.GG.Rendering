module SecondAntShowcase.Tests.Feature145OverlayVisualProofTests
...
let tests =
    testList
        "Feature145 SecondAntShowcase overlay visual correlation"
        [
            test "date-picker reference evidence carries scenario hit focus and dispatch correlation" {
                ...
                Expect.equal
                    evidence.ScenarioId
                    "feature144-antshowcase-date-picker-reference"
                    "scenario id matches harness visual proof"
                ...
                Expect.stringContains
                    evidence.DispatchSummary
                    "DatePickerChanged:2026-06-17"
                    "dispatch summary includes product selection"

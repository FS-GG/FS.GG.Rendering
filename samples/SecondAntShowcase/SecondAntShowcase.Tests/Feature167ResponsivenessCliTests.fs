module SecondAntShowcase.Tests.Feature167ResponsivenessCliTests
...
[<Tests>]
let tests =
    testList "Feature167 SecondAntShowcase responsiveness CLI" [
        test "responsiveness command writes environment-limited summary output" {
            let outDir = SecondAntShowcase.Tests.Feature167ResponsivenessFixtures.tempDir ()

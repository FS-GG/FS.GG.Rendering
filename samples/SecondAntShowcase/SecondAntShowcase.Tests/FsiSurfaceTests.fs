    ...
    testList
        ...
        [
            test "every planned public Core module has a curated .fsi file" {
                for moduleName in requiredModules do
                    ...
                    Expect.stringContains
                        ...
                        ("module SecondAntShowcase.Core." + moduleName)
                        (sprintf "%s declares the expected module" moduleName)
            }
            ...
            test "FSI authoring transcript exists and exercises the public sample surface" {
                ...
                let script =
                    Path.Combine(featureDir, "readiness", "fsi", "second-ant-showcase-authoring.fsx")

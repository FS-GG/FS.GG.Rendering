...
let tests =
    testList
        "Feature173 live responsiveness coverage"
        [
            ...
            test "display-only exclusions keep reasons" {
                ...
                let exclusions =
                    doc.RootElement.GetProperty("coverage").GetProperty("displayOnlyExclusions")

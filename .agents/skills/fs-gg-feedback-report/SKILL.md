...
`../../../template/feedback-report/skill/SKILL.md`

In this provider source repo, run the bundled tool from
`template/feedback-report/skill/scripts/feedback-tool.fsx`. Generated workspaces use the
`.agents/skills/fs-gg-feedback-report/scripts/feedback-tool.fsx` path shown by the canonical skill.

...
# Schema-v2 manifest for Rendering Skills sidecars Charter

## Identity
- Work id: `1261-rendering-skills-v2-manifest`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 1261-rendering-skills-v2-manifest`.

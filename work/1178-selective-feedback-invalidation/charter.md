...
# Detect feedback-audit invalidation at commit time Charter

## Identity
- Work id: `1178-selective-feedback-invalidation`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 1178-selective-feedback-invalidation`.

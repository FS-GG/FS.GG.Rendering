...
| [ ] | Feature 159 | P7 | Layer promotion and content/transform key split | Open P7 performance follow-up. |
...
- [ ] **Feature 159 — layer promotion and content/transform key split.** Promote stable expensive
...
accepted only when the same-profile timing lane is not noisy, Feature 159 records net-positive
reuse/promotion counters, and Feature 161 scopes the result to a known lane. If any part is missing,

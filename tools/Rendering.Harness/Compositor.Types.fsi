...
module Types =
    ...
    type Feature161LedgerEntry =
        {
            ...
            PrimaryExclusionReason: Rendering.Harness.Perf.ExclusionReason option
            TimingStatus: string
    ...
    type Feature161Msg =
        ...
        | Feature161HostFactsRejected of reason: Rendering.Harness.Perf.ExclusionReason * diagnostic: string

namespace Rendering.Harness.Compositor
    ...
    module Types =
        ...
        type Feature158TimingSample =
            {
              ...
              Path: Rendering.Harness.Perf.TimingPath
              RunId: string
              HostProfileId: string
              PackageVersion: string
              DurationMs: float
              MeasurementPolicy: Rendering.Harness.Perf.MeasurementPolicy
              InclusionStatus: Rendering.Harness.Perf.InclusionStatus
              ExclusionReason: Rendering.Harness.Perf.ExclusionReason option
              ArtifactPath: string
            }
        ...
        type Feature158ProofProbeEvidence =
            {
              ...
              ExclusionReason: Rendering.Harness.Perf.ExclusionReason
              Diagnostics: string list
            }
        ...
        type Feature160Iteration =
            {
              ...
              ActualDuration: System.TimeSpan
              WarmupCount: int
              MeasuredRepetitions: int
              ScenarioReports: Feature158ScenarioReport list
              ScenarioCoverage: string list
        ...
        type Feature160Msg =
            ...
            | Feature160IterationTimedOut of
              iterationId: string * reason: string
            | Feature160IterationCanceled of
              iterationId: string * reason: string
        ...
        type Feature160Effect =
            ...
            | Feature160EnforceIterationTimeout of
              iterationId: string * minutes: int
        ...
        type Feature161HostFacts =
            {
              ...
              CollectionTime: System.DateTimeOffset
        ...
        type Feature161Msg =
            ...
            | Feature161HostFactsRejected of

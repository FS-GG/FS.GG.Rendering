...
module Render2 =
    ...
    val emitFeature154TimingReport: tier: string -> scenarioCount: int -> repetitions: int -> string

    val emitFeature154ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature154CompatibilityLedger: model: Types.ReadinessModel -> string
    ...
    val feature155AcceptedProofs: model: Types.ReadinessModel -> Types.PresentProof list
    ...
    val emitFeature155TimingReport: tier: string -> scenarioCount: int -> repetitions: int -> string

    val emitFeature155ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature155CompatibilityLedger: model: Types.ReadinessModel -> string

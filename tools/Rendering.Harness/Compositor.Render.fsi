...
module Render =
    ...
    val emitFeature148ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature148CompatibilityLedger: model: Types.ReadinessModel -> string
    ...
    val emitFeature149ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature149CompatibilityLedger: model: Types.ReadinessModel -> string
    ...
    val emitFeature152ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature152CompatibilityLedger: model: Types.ReadinessModel -> string

    val emitFeature153LiveProof: proof: Types.PresentProof -> string

    val emitFeature153ProofSet: model: Types.ReadinessModel -> string

    val emitFeature153ValidationSummary: model: Types.ReadinessModel -> string

    val emitFeature153CompatibilityLedger: model: Types.ReadinessModel -> string

    val renderValidationDoc: featureNum: int -> kind: string -> status: string -> body: string list -> string

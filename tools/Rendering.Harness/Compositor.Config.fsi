...
module Config =
    ...
    val d148: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d149: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d152: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d153: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d154: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d155: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d156: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d157: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d158: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d159: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d160: Rendering.Harness.FeatureCatalog.FeatureDescriptor

    val d161: Rendering.Harness.FeatureCatalog.FeatureDescriptor
    ...
    val thresholds: Types.Thresholds

    val snapshotBudget: Types.SnapshotBudget

    val scenarioIds: string list

    val targetHostProfiles: Types.HostProfile list

    val feature148ScenarioIds: string list

    val feature148TargetHostProfiles: Types.HostProfile list

    val feature148TimingTiers: string list

    val feature149ScenarioIds: string list

    val feature149TargetHostProfiles: Types.HostProfile list

    val feature149TimingTiers: string list

    val feature152ScenarioIds: string list

    val feature152TargetHostProfiles: Types.HostProfile list

    val feature152TimingTiers: string list

    val feature153ScenarioIds: string list

    val feature153TargetHostProfiles: Types.HostProfile list

    val feature154ScenarioIds: string list

    val feature154TargetHostProfiles: Types.HostProfile list

    val feature154TimingTiers: string list

    val feature155ScenarioIds: string list

    val feature155TargetHostProfiles: Types.HostProfile list
    ...
    val feature156TargetHostProfiles: Types.HostProfile list
    ...
    val feature157TargetHostProfiles: Types.HostProfile list

    val feature158RequiredScenarioIds: string list

    val feature158ScenarioIds: string list

    val feature158TargetHostProfiles: Types.HostProfile list
    ...
    val feature159TargetHostProfiles: Types.HostProfile list

    val feature160RequiredScenarioIds: string list

    val feature160ScenarioIds: string list

    val feature160TargetHostProfiles: Types.HostProfile list

    val feature161RequiredScenarioIds: string list

    val feature161NonGeneralizedLanes: string list

    val feature161PriorGateLinks: Types.Feature161PriorGate list

    val backendToken: backend: Rendering.Harness.Backend -> string

    val hostProfileFromFacts: facts: Rendering.Harness.ProbeFacts -> Types.HostProfile

    val proofVerdictToken: verdict: Types.ProofVerdict -> string

    val parityVerdictToken: verdict: Types.ParityVerdict -> string

    val tierToken: tier: Types.CompositorTier -> string

    val tierVerdictToken: verdict: Types.TierVerdict -> string

    val tierDisplayName: tier: Types.CompositorTier -> string

    val verdictReason: verdict: Types.TierVerdict -> string

    val proofMatchesHost: active: Types.HostProfile -> proof: Types.PresentProof -> bool

    val proofIsFresh: now: System.DateTimeOffset -> maxAge: System.TimeSpan -> proof: Types.PresentProof -> bool

    val validateProofForScissoring:
        active: Types.HostProfile ->
        now: System.DateTimeOffset ->
        maxAge: System.TimeSpan ->
        proof: Types.PresentProof option ->
            Types.TierVerdict

    val evaluateTier:
        proof: Types.TierVerdict ->
        parity: Types.ParityVerdict option ->
        performancePassed: bool option ->
            Types.TierVerdict

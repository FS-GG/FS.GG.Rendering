...
module FeatureCatalog =
    ...
    let catalog: FeatureDescriptor list =
        [
            descriptor
                148
                "148-compositor-live-integration"
                [
                    ValidationSummary
                    CompatibilityLedger
                    LiveProof
            ...
            descriptor
                153
                "153-compositor-proof-interpreter"
                [
                    ValidationSummary
                    CompatibilityLedger
                    LiveProof
                ...
                (hdr
                    153
                    [
                        "Live Proof Interpreter"
                        "Proof-Set Decision"
                        "Compositor Proof Interpreter Readiness"
                        "Compatibility Ledger"
                    ])
                emptyConfig
            descriptor
                ...
                (hdr
                    154
                    [
                        "Compositor Proof Acceptance"
                        "Same-Profile Damage-Scoped Parity"
                        "Timing Decision"
                        "Proof-Set Acceptance"
                        "P7 Readiness Verdict"
                        "Compatibility Ledger"
                    ])
                emptyConfig
            descriptor
                155
                "155-native-proof-capture"
                [
                    ValidationSummary
                    CompatibilityLedger
                    LiveProof
            ...
            descriptor
                ...
                (hdr
                    ...
                    [
                        "Readiness Summary"
                        "Same-Profile Timing Summary"
                        "Unsupported Host Timing"
                        "Compatibility Ledger"
                    ])
                { emptyConfig with
            ...
            descriptor
                ...
                (hdr
                    ...
                    [
                        "Readiness Summary"
                        "Layer Promotion Summary"
                        "Promotion Attempt"
                        "Counter Evidence"
                        "Unsupported Host Promotion"
                        "Compatibility Ledger"
                    ])
                { emptyConfig with
            ...
            descriptor
                160
                "160-performance-validation-throughput"
                [
                    ValidationSummary
                    CompatibilityLedger
                    PackageValidation
                ...
                (hdr
                    ...
                    [
                        "Readiness Summary"
                        "Focused Throughput Summary"
                        "Focused Throughput Iteration"
                        "Full Validation"
                        "Unsupported Host Throughput"
                        "Compatibility Ledger"
                    ])
                { emptyConfig with
            ...
            descriptor
                ...
                (hdr
                    ...
                    [
                        "Readiness Summary"
                        "Host Performance Lane Ledger"
                        "Lane Ledger Entry"
                        "Host Facts"
                        "Full Validation"
                        "Unsupported Host Lane Ledger"
                        "Compatibility Ledger"
                    ])
                { emptyConfig with
    ...
    let private assertUniqueAliases =
        ...
        | [] -> ()
        | dups ->
            raise (CatalogError(sprintf "duplicate CLI alias(es) in FeatureCatalog: %s" (String.concat ", " dups)))

...
try {
  ...
  const evidence={labels,created,preview,cancelled,scene,camera,placement,workspace,resource,geometryCancelled,disposed,remounted,disposedAgain,roots};

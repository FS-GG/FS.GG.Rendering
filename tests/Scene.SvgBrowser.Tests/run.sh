...
source_digest="$(cat "$repo/src/KeyboardInput/KeyboardInput.fsi" "$repo/src/KeyboardInput/KeyboardInput.fs" "$repo/src/KeyboardInput/CommandInput.fsi" "$repo/src/KeyboardInput/CommandInput.fs" "$repo/src/KeyboardInput/CommandResolver.fsi" "$repo/src/KeyboardInput/CommandResolver.fs" "$repo/src/Scene.SvgBrowser/SvgBrowser.fsi" "$repo/src/Scene.SvgBrowser/SvgBrowser.fs" "$repo/src/Scene.SvgBrowser/SvgStudio.fsi" "$repo/src/Scene.SvgBrowser/SvgStudio.fs" | sha256sum | cut -d' ' -f1)"

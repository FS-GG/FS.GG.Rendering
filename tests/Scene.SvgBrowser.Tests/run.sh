...
source_digest="$(cat "$repo/src/KeyboardInput/KeyboardInput.fsi" "$repo/src/KeyboardInput/KeyboardInput.fs" "$repo/src/KeyboardInput/CommandInput.fsi" "$repo/src/KeyboardInput/CommandInput.fs" "$repo/src/KeyboardInput/CommandResolver.fsi" "$repo/src/KeyboardInput/CommandResolver.fs" "$repo/src/Scene/SvgWorkspace.fsi" "$repo/src/Scene/SvgWorkspace.fs" "$repo/src/Scene.SvgBrowser/SvgBrowser.fsi" "$repo/src/Scene.SvgBrowser/SvgBrowser.fs" "$repo/src/Scene.SvgBrowser/SvgInputHost.fsi" "$repo/src/Scene.SvgBrowser/SvgInputHost.fs" "$repo/src/Scene.SvgBrowser/SvgSessionHost.fsi" "$repo/src/Scene.SvgBrowser/SvgSessionHost.fs" "$repo/src/Scene.SvgBrowser/SvgStudio.fsi" "$repo/src/Scene.SvgBrowser/SvgStudio.fs" | sha256sum | cut -d' ' -f1)"
...
with zipfile.ZipFile(adapter) as archive:
    ...
    expected={'fable/FS.GG.UI.Scene.SvgBrowser.fsproj','fable/SvgBrowser.fsi','fable/SvgBrowser.fs','fable/SvgInputHost.fsi','fable/SvgInputHost.fs','fable/SvgSessionHost.fsi','fable/SvgSessionHost.fs','fable/SvgStudio.fsi','fable/SvgStudio.fs'}
    if fable != expected:

...
with zipfile.ZipFile(adapter) as archive:
    ...
    expected={'fable/FS.GG.UI.Scene.SvgBrowser.fsproj','fable/SvgBrowser.fsi','fable/SvgBrowser.fs','fable/SvgInputHost.fsi','fable/SvgInputHost.fs','fable/SvgStudio.fsi','fable/SvgStudio.fs'}
    if fable != expected:

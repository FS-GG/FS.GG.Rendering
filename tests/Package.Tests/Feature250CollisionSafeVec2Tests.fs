...
let private vec2Source =
    File.ReadAllText(repositoryPath "template/fragments/vec2/src/Product/Vec2.fs")

let private modelSource =
    File.ReadAllText(repositoryPath "template/base/src/Product/Model.fs")

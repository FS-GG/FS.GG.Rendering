...
let private feature157InMemoryTests =
    [
        test "SkiaViewer exposes additive damage decision and diagnostics vocabulary" {
            Expect.equal
                (Viewer.damageDecisionToken ViewerDamageDecision.FullRedraw)
                "full-redraw"
                "viewer damage token"
...
let private featureChecks: (int * string * Check list) list =
    [
        148,
        "Feature148 compatibility ledger",
        [
            {
                Name =
                    "compatibility ledger records public metrics, baselines, release notes, migration, and limitations"
        ...
        149,
        "Feature149 compatibility ledger",
        [
            {
                Name =
                    "compatibility ledger records public metrics, baselines, release notes, migration, and limitations"
            ...
            {
                Name =
                    "validation summary lists live proof, damage, placement, replay, snapshot, timing, and diagnostics"
        ...
        152,
        "Feature152 compatibility ledger",
        [
            {
        ...
        153,
        "Feature153 compatibility ledger",
        [
            {
            ...
            {
                Name =
                    "validation summary records environment-limited status without partial-redraw or performance overclaim"
        ...
        154,
        "Feature154 compatibility ledger",
        [
            {
        ...
        155,
        "Feature155 compatibility closeout",
        [
            {
        ...
        156,
        "Feature156 compatibility package",
        [
            {
            ...
            }
            {
                ...
                Tokens =
                    [
                        ...
                        "SkiaViewer, Testing, and harness signatures"
                    ]
            }
        ]

        158,
        "Feature158 compatibility package",
        [
            {
            ...
            }
            {
                ...
                Tokens =
                    [
                        ...
                        "No Testing or SkiaViewer package-visible helper surface"
                    ]
            }
            {
        ...
        159,
        "Feature159 compatibility package",
        [
            {
        ...
        160,
        "Feature160 compatibility package",
        [
            {
        ...
        161,
        "Feature161 compatibility package",
        [
            {
            ...
            {
                Name =
                    "validation summary links ledger full validation compatibility package regression and unsupported-host evidence"
...
let tests =
    testList
        "Feature compatibility (catalog data-driven)"
        [
            ...
            yield
                test "catalog coverage: compatibility checks cover exactly the FeatureCatalog ids" {
                    let covered = featureChecks |> List.map (fun (id, _, _) -> id)

                    Expect.equal
                        covered
                        [ 148; 149; 152; 153; 154; 155; 156; 157; 158; 159; 160; 161 ]
                        "covers exactly the catalog ids (mirrors FeatureCatalog.catalog)"
                }
        ]

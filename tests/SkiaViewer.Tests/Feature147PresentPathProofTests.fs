    ...
    testList
        ...
        [
            test "readiness accepts only fresh matching passed proof" {
                ...
                Expect.equal
                    (CompositorProof.readiness profile now maxAge (Some(passedProof now)))
                    CompositorProof.ProofReadiness.Ready
                    "fresh proof"

                Expect.equal
                    (CompositorProof.readiness profile now maxAge None)
                    CompositorProof.ProofReadiness.Missing
                    "missing proof"

                Expect.equal
                    (CompositorProof.readiness profile now maxAge (Some(passedProof (now - TimeSpan.FromHours 2.0))))
                ...
                Expect.equal
                    (CompositorProof.readiness other now maxAge (Some(passedProof now)))
            ...
            test "observation classification distinguishes passed, cleared, and limited evidence" {
                ...
                Expect.equal
                    (CompositorProof.classifyObservations cleared)
            ...
            test "MVU update emits sentinel, damage, observe, and artifact effects" {
                ...
                let m1, e1 =
                    CompositorProof.update now "proof.md" (CompositorProof.ProfileDetected profile) m0
                ...
                let m2, e2 =
                    CompositorProof.update now "proof.md" CompositorProof.SentinelPresented m1
                ...
                let m3, e3 =
                    CompositorProof.update now "proof.md" CompositorProof.DamagePresented m2
                ...
                let m4, e4 =
                    CompositorProof.update
                        now
                        "proof.md"
                        (CompositorProof.ObservationCompleted
                            [
                                observation "u1" CompositorProof.ObservedRegionKind.Untouched true
                                observation "d1" CompositorProof.ObservedRegionKind.Damaged true
                            ])

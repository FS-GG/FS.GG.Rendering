...
let tests =
    testList
        "Feature154 Synthetic rejection gates"
        [
            test "Feature154_Synthetic stale missing blank undecodable and synthetic artifacts are fallback-gated" {
                ...
                [
                    attempt
                        "stale"
                        CompositorProof.PresentProofPassed
                        (quality true true true false false)
                        [ "proof.md" ]
                    ...
                    attempt
                        "undecodable"
                        CompositorProof.PresentProofPassed
                        (quality true false true true false)
                        [ "proof.md" ]
                    attempt
                        "synthetic"
                        CompositorProof.PresentProofPassed
            ...
            test "Feature154_Synthetic incomplete evidence and unsupported host remain non-accepting" {
                ...
                let incomplete =
                    attempt "incomplete" CompositorProof.PresentProofPassed (quality true true true true false) []
                ...
                Expect.equal
                    (evaluate [ unsupported; unsupported; unsupported ])
                    "environment-limited"
                    "unsupported host"
            }

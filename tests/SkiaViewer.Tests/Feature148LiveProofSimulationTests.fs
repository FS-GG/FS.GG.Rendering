...
let tests =
    testList
        "Feature148 Synthetic live proof simulations"
        [
            ...
            test
                "Feature148 Synthetic missing display timeout permission and host error remain disclosed failure categories" {

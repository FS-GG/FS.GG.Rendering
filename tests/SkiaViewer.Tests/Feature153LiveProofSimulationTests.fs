...
let tests =
    testList
        "Feature153 Synthetic live proof simulations"
        [
            test "Feature153_Synthetic unsupported host stays environment-limited with zero accepted attempts" {
                ...
                let limited =
                    attempt "limited" (CompositorProof.PresentProofEnvironmentLimited "missing display") (quality false)
                ...
                Expect.equal
                    ...
                    "environment-limited"
                    "unsupported host cannot accept"
            }
            ...
            test "Feature153_Synthetic readback limited classifier does not accept missing observations" {
                ...
                Expect.equal
                    (CompositorProof.verdictToken verdict)
                    "environment-limited"
                    "missing readback observations are limited"
            }
            ...
            test "Feature153_Synthetic fewer than three attempts remain fallback-gated" {
                ...
                Expect.equal
                    (CompositorProof.proofSetReadinessToken readiness)
                    "fallback-gated"
                    "fewer than three attempts cannot accept"
            }
        ]

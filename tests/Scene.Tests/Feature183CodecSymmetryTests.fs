...
let private allCases: SceneNode list =
    [
        ...
        GlyphRun(
            {
                Data = Scene.buildGlyphRun "glyph" font
                Position = { X = 0.0; Y = 0.0 }
                Paint = paint
            }
        ) // 23
...
let private baselineSha =
    "be1397bcc3783746c769791383549cd4fc063474e202dd3358fd3fda539eb96b"

[<Tests>]
let tests =
    testList
        "Feature183CodecSymmetry"
        [

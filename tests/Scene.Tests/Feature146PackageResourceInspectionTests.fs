...
let feature146PackageResourceInspectionTests =
    testList
        "Feature146 package resource availability inspection"
        [
            test "optional missing resource degrades package" {
                ...
                Expect.exists
                    ...
                    (fun verdict -> verdict.Entry.ResourceId = "optional-font" && verdict.Degraded)
                    "optional resource verdict degrades"
            }
            ...
            test "duplicate availability rejects package" {
                ...
                Expect.exists
                    report.Diagnostics
                    (fun d -> d.ResourceId = Some "optional-font")
                    "duplicate diagnostic names resource"
            }
        ]

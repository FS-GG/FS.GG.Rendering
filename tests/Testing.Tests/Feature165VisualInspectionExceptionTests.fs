        ...
        [
            test "required-region-painted blocks missing root coverage" {
                let art =
                    artifact
                        [
                            region "root" VisualInspectionSurfaceRole.Root (rect 0.0 0.0 320.0 200.0) true
                        ]
                        []
                        []
                ...
                let result =
                    VisualInspectionValidation.validate
                        art
                        [ VisualInspectionValidation.rule "required-region-painted" ]
                        []
            ...
            test "overlay-overlap-classified is accepted only with a valid matching exception" {
                ...
                Expect.equal
                    ...
                    "unclassified overlay overlap blocks"
                ...
                Expect.equal
                    accepted.ReadinessStatus
                    VisualInspectionStatus.Accepted
                    "valid exception accepts the overlap finding"
            ...
            test "invalid and unused exceptions are visible diagnostics" {
                ...
                let result =
                    VisualInspectionValidation.validate
                        ...
                        [
                            invalid
                            ex "unused" "overlay-overlap-classified" [ "a"; "b" ] "stale allowance"
                        ]

                Expect.equal
                    result.ReadinessStatus
                    VisualInspectionStatus.Blocked
                    "invalid exception blocks accepted readiness"
            ...
            test "accidental clipping remains blocking without a matching exception" {
                ...
                let art =
                    artifact
                        [
                            region "content" VisualInspectionSurfaceRole.Content (rect 0.0 0.0 100.0 20.0) false
                        ]
                        []
                        [ clip ]
                ...
                let result =
                    VisualInspectionValidation.validate
                        art
                        [ VisualInspectionValidation.rule "clip-intent-classified" ]
                        []

    ...
    testList
        ...
        [
            ...
            test "managed section insertion replacement and unsafe marker states are deterministic" {
                ...
                let replacement =
                    VisualInspectionMarkdown.updateManagedSection
                        inserted.UpdatedText
                        "## Visual Inspection\n\nreplacement"
                ...
                Expect.isFalse
                    (replacement.UpdatedText.Contains("bounded representative evidence"))
                    "old generated section replaced"

                let malformed =
                    VisualInspectionMarkdown.updateManagedSection
                        (VisualInspectionMarkdown.startMarker
                         + "\n"
                         + VisualInspectionMarkdown.startMarker)
                        generated

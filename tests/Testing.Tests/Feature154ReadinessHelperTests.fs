...
let tests =
    testList
        "Feature154 compositor readiness helper"
        [
            ...
            test "failed package or missing evidence blocks final readiness" {
                let missing =
                    {
                        ...
                        Evidence =
                            [
                                { evidence "validation-summary.md" CompositorReadinessMissingEvidence with
                                    EvidencePath = None
                                }
                            ]
                        Limitations = []
                ...
                Expect.equal
                    (CompositorReadiness.validate missing).Status

        ...
        [
            test "full-surface localized damage is blocked and true-union evidence is checked" {
                ...
                Expect.equal
                    ...
                    "full surface blocks localized readiness"

                Expect.exists
                    result.Findings
                    (fun finding -> finding.RuleId = "full-surface-localized-change-blocked")
                    "full-surface finding"
            }
            ...
            test "unsupported required retained facts do not become accepted readiness" {
                ...
                Expect.equal
                    ...
                    "required unsupported fact blocks acceptance"

                Expect.exists
                    result.Findings
                    (fun finding -> finding.RuleId = "unsupported-damage-explicit")
                    "unsupported finding"
            }
            ...
            test "an inspected damage transition keeps self-declared accepted" {
                ...
                let result =
                    RetainedInspectionValidation.validate (artifact "fixture" damage []) [] []
                ...
                Expect.equal
                    ...
                    "an inspected transition certifies accepted"
            }

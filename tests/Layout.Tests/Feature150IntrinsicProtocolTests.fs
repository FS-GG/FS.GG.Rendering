    ...
    testList
        ...
        [
            ...
            test "measureProtocol reports measured size and child placement evidence" {
                ...
                Expect.isTrue
                    (measured.MeasuredSize.MeasuredWidth >= 0.0
                     && measured.MeasuredSize.MeasuredHeight >= 0.0)
                    "measured size is bounded"
            ...
            test "explicit intrinsic query returns accepted natural height evidence" {
                ...
                let query =
                    Layout.intrinsicQuery root.Id IntrinsicMaxHeight (Some 120.0) inputKey DiagnosticProbe

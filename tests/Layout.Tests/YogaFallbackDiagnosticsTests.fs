...
let yogaFallbackDiagnosticsTests =
    testSequenced
    <| testList
        "Yoga failure diagnostics"
        [
            test
                "Yoga execution failure collapses geometry and reports an error rather than substituting a second engine" {
                let root =
                ...
                try
                    ...
                    Expect.equal
                        ...
                        2
                        "every node still has an entry, so callers keep their node/bounds correspondence"
            ...
            test "Yoga execution failure never emits overlapping or container-overflowing geometry" {
                ...
                try
                    ...
                    Expect.isLessThanOrEqual
                        ...
                        "children do not overflow their container"
                finally
                    AppContext.SetSwitch("FS.GG.UI.Layout.ForceYogaFailure", false)
            }
        ]

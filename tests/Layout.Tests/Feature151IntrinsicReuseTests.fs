    ...
    testList
        ...
        [
            ...
            test "dynamic content changes intrinsic dependency identity" {
                ...
                Expect.notEqual
                    changedQuery.QueryIdentity
                    baselineQuery.QueryIdentity
                    "layout input key participates in query identity"
                ...
                Expect.notEqual
                    changedResult.Dependencies
                    baselineResult.Dependencies
                    "intrinsic dependency result identities"
            }
            ...
            test "cacheEntry records intrinsic dependency keys and revision" {
                ...
                let entry =
                    Layout.cacheEntry
                        ...
                        node.Id
                        query.QueryIdentity
                        query.LayoutInputKey
                        (result.Dependencies |> List.map _.ResultIdentity)
                        $"{result.Size:R}"

    ...
    testList
        ...
        [
            test "Synthetic operator cancellation preserves completed lanes and marks unfinished lanes" {
                ...
                try
                    ...
                    let canceled, effects =
                        ValidationLanes.update (ValidationLanes.OperatorCanceled "operator canceled") model
            ...
            test "Synthetic readiness is blocked when required lanes are canceled skipped or not-run" {
                ...
                [ ValidationLanes.Canceled; ValidationLanes.Skipped; ValidationLanes.NotRun ]

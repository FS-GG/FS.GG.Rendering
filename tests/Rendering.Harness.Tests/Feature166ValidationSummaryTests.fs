        ...
        [
            ...
            test "Synthetic readiness rules keep optional aggregate failures separate from required readiness" {
                ...
                let readyWithOptionalFailure =
                    [
                        Feature166TestFixtures.result
                            Feature166TestFixtures.syntheticRunRoot
                            "build"
                            ValidationLanes.Required
                ...
                Expect.equal
                    (ValidationLanes.computeOverallReadiness readyWithOptionalFailure)
                    ValidationLanes.Ready
                    "optional failure separate"
                ...
                Expect.equal
                    (ValidationLanes.computeOverallReadiness incomplete)
            ...
            test "replacement notice is rendered when a run is explicitly replaced" {
                ...
                try
                    let summary =
                        { Feature166TestFixtures.summary
                              root
                              [
                                  Feature166TestFixtures.result
                                      root

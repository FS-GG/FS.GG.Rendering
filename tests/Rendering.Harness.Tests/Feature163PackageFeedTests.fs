        ...
        [
            test "discovers packable packages and classifies stale current and missing pins" {
                ...
                try
                    ...
                    Feature163TestFixtures.writePackageProject root "src/Scene/Scene.fsproj" "FS.GG.UI.Scene" "1.2.4"
                    |> ignore
                    ...
                    Expect.equal
                        byId["FS.GG.UI.Unknown"].Status
                        PackageFeed.MissingExpectedPackage
            ...
            test "pure MVU emits discovery sample feed restore and evidence effects" {
                ...
                let failed, failedEffects =
                    PackageFeed.update (PackageFeed.WorkflowFailed "boom") model
            ...
            test "accepted compatibility exception is explicit and not a silent stale-pin pass" {
                ...
                try
                    ...
                    let pins =
                        PackageFeed.readSelectedPackagePins
                            root
                            [ "samples/Demo" ]
                            packages
                            (Set.ofList [ ex.Id ])

        ...
        [
            test "retained-inspection lane is listed with focused command and artifact paths" {
                ...
                try
                    ...
                    Expect.equal
                        lane.EvidenceDirectory
                        (Path.Combine(runRoot, "retained-inspection"))
            ...
            test "explicit retained-inspection selection is accepted and unknown lane fails clearly" {
                ...
                try
                    ...
                    | Ok plan ->
                        ...
                        Expect.equal
                            (plan.SelectedLanes |> List.map _.Id)
                            [ "retained-inspection" ]
                            "retained lane selected"
                    ...
                    | Error diagnostics ->
                        Expect.exists
                            ...
                            (fun d ->
                                d.Code = "unknown-lane"
                                && d.LaneIds |> List.contains "missing-retained-inspection")
                            "unknown lane diagnostic names id"
                finally
                    Feature166TestFixtures.deleteTempRoot root
            }

...
let tests =
    testList
        "Feature148 live proof evidence"
        [
            ...
            test "Feature148 proof corpus includes real and environment-limited host cases" {
                ...
                Expect.isTrue
                    (Compositor.Config.feature148TargetHostProfiles
                     |> List.exists (fun profile -> profile.ProfileId = "synthetic-non-preserving"))
            ...
            test "Feature148 Synthetic simulated host evidence remains environment-limited" {
                ...
                Expect.isTrue
                    (TestAssertions.feature148EnvironmentLimited token)

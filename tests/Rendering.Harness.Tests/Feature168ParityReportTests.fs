        ...
        [
            test "passing fixture report Markdown and JSON agree on status and counts" {
                ...
                try
                    ...
                    let high =
                        doc.RootElement.GetProperty("findingCountsBySeverity").GetProperty("high").GetInt32()
            ...
            test "CLI-style JSON report contains first high finding visibility for fixture mode" {
                ...
                try
                    let report =
                        SkillParity.runCheck (Feature168SkillParityFixtures.request root "broken-target")

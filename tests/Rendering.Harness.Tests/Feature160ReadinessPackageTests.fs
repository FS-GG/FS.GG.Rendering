    ...
    testList
        ...
        [
            ...
            test "unsupported host and excluded evidence record zero accepted performance contribution" {
                let unsupported =
                    Compositor.Render4.emitFeature160UnsupportedHostReport "missing display"
                ...
                let excluded =
                    Compositor.Render4.emitFeature160ExcludedEvidenceReport Perf.PartialEvidence [ excludedIteration ]

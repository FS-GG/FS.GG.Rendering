        ...
        [
            ...
            Stack.children
                [
                    ...
                    NumericInput.create
                        [
                            NumericInput.value 5.0
                            NumericInput.onChanged NumChanged
                            Attr.width 120.0
                            Attr.height 32.0
                        ]
                    |> Control.withKey "num"
    ...
    testList
        ...
        [
            test "radio-group / tabs / numeric-input clicks report the right value, not the default" {
                ...
                | [ NumChanged v ] ->
                    Expect.floatClose Accuracy.medium v 5.0 "a numeric-input click reports its current value"

                    ...
                    CompositorPolicy.damageRegionSet
                        {
                            ...
                            Boxes = [ rect 10.0 10.0 24.0 16.0 ]
                        }

                let movement =
                    CompositorPolicy.placementDamage 120 100 (rect 10.0 10.0 24.0 16.0) (rect 40.0 10.0 24.0 16.0)
                    ...
                    CompositorPolicy.damageRegionSet
                        {
                            ...
                            Cause = "damage/full-invalidation"
                            Boxes = [ rect 0.0 0.0 120.0 100.0 ]
                        }

                Expect.equal
                    (CompositorPolicy.classifyDamageFallback true None localized)
                    None
                    "localized can be scoped when proof is ready"
                    ...
                    CompositorPolicy.damageRegionSet
                        {
                            ...
                            FrameHeight = 100
                            FullFrameInvalidation = false
                            Cause = "damage/invalid-damage"
                            Boxes = [ rect -20.0 -20.0 200.0 200.0 ]
                        }

...
let feature234ThemeRoleColorTests =
    testList
        "Review P3 theme role colours (#46)"
        [
            ...
            test "AntDesign Dark resolves its own Success/Warning fields" {
                ...
                Expect.equal
                    (successFill AntTheme.antDark)
                    AntTheme.antDark.Success
                    "Ant dark Success comes from the Ant theme"

                Expect.equal
                    (warningStroke AntTheme.antDark)
                    AntTheme.antDark.Warning
                    "Ant dark Warning comes from the Ant theme"
            }

    ...
    testList
        ...
        [
            ...
            test "Font Size overrides the base size; a None weight leaves the folded weight" {
                let s =
                    Style.resolve theme buttonBase [ StyleClass.Font { Size = Some 24.0; Weight = None } ] Normal
            ...
            test "Font Weight overrides the base weight; a None size leaves the folded size" {
                let s =
                    Style.resolve theme buttonBase [ StyleClass.Font { Size = None; Weight = Some 700 } ] Normal
            ...
            test "a Font class changes ONLY typography — every colour field is untouched" {
                let s =
                    Style.resolve theme buttonBase [ StyleClass.Font { Size = Some 20.0; Weight = Some 600 } ] Normal
            ...
            test "a neutral button's base FontSize tracks theme.FontSize (part 2)" {
                Expect.equal
                    buttonBase.FontSize
                    theme.FontSize
                    "baseStyleFor tracks the theme body size, not a frozen 15.0"
            }
            ...
            test "a Font class reaches the emitted label AND widens the button to fit it" {
                ...
                let big =
                    WidgetGeometry.buttonGeom
                        theme
                        box
                        [ StyleClass.Font { Size = Some 48.0; Weight = Some 700 } ]
                        Normal
                        "button"
                        ""
                        label
                ...
                Expect.isGreaterThan
                    (widestRect big)
                    (widestRect plain)
                    "the big-font button is wider than the plain one"
            }
        ]

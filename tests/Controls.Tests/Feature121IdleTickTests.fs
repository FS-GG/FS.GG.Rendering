    ...
    testList
        ...
        [
            ...
            test "an active clock advances by the delta exactly as the per-clock oracle (099/103 unchanged)" {
                ...
                let advanced =
                    RetainedRender.advanceStateClocks (TimeSpan.FromMilliseconds 100.0) state
                ...
                | Some c ->
                    Expect.equal
                        ...
                        "the active clock advanced by the 100ms delta (250→350)"

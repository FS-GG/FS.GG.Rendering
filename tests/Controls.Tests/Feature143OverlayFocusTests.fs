    ...
    testList
        ...
        [
            ...
            test "stale focus target recovers to the declared recovery target" {
                let opened, _ =
                    openOne (surface TransientSurfaceKind.DatePickerCalendar "calendar" 10)

                let recovered, effects =
                    OverlayState.update (FocusTargetRemoved "calendar-item-1") opened

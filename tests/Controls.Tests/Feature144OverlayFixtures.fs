...
let widgetControls () =
    ...
    let combo =
        FS.GG.UI.Controls.Typed.ComboBox.view comboProps comboModel |> Widget.toControl
            ...
            { FS.GG.UI.Controls.Typed.ColorPicker.defaults with
                ...
                Swatches =
                    [
                        {
                            Name = "Blue"
                            Color = Colors.rgb 0uy 0uy 255uy
                        }
                    ]
            }
        |> Widget.toControl
    ...
    let dialog =
        FS.GG.UI.Controls.Typed.Dialog.view
            { FS.GG.UI.Controls.Typed.Dialog.defaults with
                ...
                Children =
                    [
                        FS.GG.UI.Controls.Typed.Tooltip.view
                            { FS.GG.UI.Controls.Typed.Tooltip.defaults with
                                Text = "body"
                            }
                    ]
            }

    ...
    testList
        ...
        [
            ...
            test "Synthetic cross-profile reuse is rejected with zero accepted counters" {
                ...
                let placement =
                    CompositorPolicy.feature159PlacementIdentity "row-1" None 0.0 0.0 1.0 []
                ...
                Expect.equal
                    (decision.PrimaryReason |> Option.map CompositorPolicy.feature159ReasonToken)
                    (Some "cross-profile-evidence")
                    "cross-profile"

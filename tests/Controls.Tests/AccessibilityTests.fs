...
let typedGalleryAccessibilityTests =
    testList
        "Feature 071 typed gallery accessibility (US2)"
        [
            ...
            test "typed gallery panel exposes expected accessibility roles at two viewports (SC-005, G6)" {
                ...
                let roleOf kind =
                    (Accessibility.defaultFor kind "typed").Role
...
let expansionAccessibilityTests =
    ...
    testList
        "Feature 072 new-control accessibility (FR-009, SC-005)"
        [
...
let accessibilityTests =
    testList
        "Controls accessibility metadata"
        [
            ...
            test "missing accessibility and low contrast fail diagnostics" {
                let lowContrast =
                    Accessibility.metadata
                        ...
                        [ "normal" ]
                        (Some 1)
                        (Accessibility.keyboard true [ "Enter" ] [ "Tab" ])
                        (Some(Accessibility.contrast FS.GG.UI.Scene.Colors.black FS.GG.UI.Scene.Colors.black 1.0 4.5))
                        None

    ...
    testList
        ...
        [ test "the product-skill corpus yields F# fences (no silent zero)" {
          ...
          test "every product-skill fence has a current explicit compilation disposition" {
              ...
              Expect.equal plan.Length 90 "the reviewed whole-corpus inventory remains exact"
              ...
              Expect.equal contextualReasons.Length 76 "every remaining teaching fragment is accounted for"

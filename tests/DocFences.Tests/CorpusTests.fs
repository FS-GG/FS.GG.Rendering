    ...
    testList
        ...
        [ test "the product-skill corpus yields F# fences (no silent zero)" {
          ...
          test "every product-skill fence has a current explicit compilation disposition" {
              ...
              Expect.equal plan.Length 87 "the reviewed whole-corpus inventory remains exact"
              ...
              Expect.equal contextualReasons.Length 72 "every remaining teaching fragment is accounted for"
